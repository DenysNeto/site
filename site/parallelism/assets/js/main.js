(function ($) {
  ...
  if (browser.name == "ie") $wrapper.css("height", "100vh");

  // iOS: Compensate for address bar.
  if (browser.os == "ios") $wrapper.css("min-height", "calc(100vh - 30px)");
    ...
    (function () {
      $window
        ...
        .on("keydown", function (event) {
          ...
          if ($body.hasClass("is-poptrox-visible")) return;

          switch (event.keyCode) {
            // Left arrow.
            case 37:
              $main.scrollLeft(
                $main.scrollLeft() - settings.keyboardShortcuts.distance
              );
              scrolled = true;
              break;
      ...
      var $left = $('<div class="scrollZone left"></div>'),
        ...
        activate = function (d) {
          ...
          intervalId = setInterval(function () {
            $main.scrollLeft(
              $main.scrollLeft() + settings.scrollZones.speed * direction
            );
          }, 25);
        },
        deactivate = function () {
